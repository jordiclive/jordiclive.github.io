...
As I have some spare time over the next two weeks, full(er) write-ups will appear. I am currently 14th/3228 on the [public LB](https://www.kaggle.com/c/elo-merchant-category-recommendation/leaderboard) of my first Kaggle competition—some ML techniques were required (I promise!).
